...
Color scheme: Joveo brand (Port Gore navy #202058, Blue Violet #5A54BD)
...
# ---------------------------------------------------------------------------
# Joveo Brand Colors (print-friendly adaptations)
# ---------------------------------------------------------------------------
...
<body>
  ...
  <div class="report-header">
    <img src="/assets/joveo-logo.png" alt="Joveo" class="report-logo"
  ...
  <div class="report-footer">
    Generated by <span class="brand">Joveo Media Plan Generator</span>
