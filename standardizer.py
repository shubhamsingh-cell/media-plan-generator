...
def get_channels_key(canonical_industry: str) -> str:
    ...
    return meta.get("channels_key", meta.get("deep_bench_key") or "")
...
CANONICAL_ROLES: Dict[str, Dict[str, Any]] = {
    ...
    "data_engineer": {
        "aliases": ["etl developer", "data platform engineer", "analytics engineer"],
        "soc": "15-1252",
        "tier": "professional",
        "category": "data_analytics",
    },
    ...
    "network_engineer": {
        "aliases": ["network administrator", "network architect", "systems engineer"],
        "soc": "15-1241",
        "tier": "professional",
        "category": "technology_it",
    },
    ...
    "accountant": {
        "aliases": ["auditor", "bookkeeper", "tax preparer", "cpa", "controller"],
        "soc": "13-2011",
        "tier": "professional",
        "category": "professional_white_collar",
    },
    ...
    "security_guard": {
        "aliases": ["security officer", "loss prevention", "security specialist"],
        "soc": "33-9032",
        "tier": "entry",
...
PLATFORM_ALIASES: Dict[str, List[str]] = {
    ...
    "linkedin": ["LinkedIn", "linkedin.com", "linkedin_jobs", "linkedin_recruiter"],
    "ziprecruiter": [
        "ZipRecruiter",
        "zip recruiter",
        "zip_recruiter",
