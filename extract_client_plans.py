...
def extract_channels_from_cells(cells, known_non_channels=None):
    ...
    channels = set()
    skip_values = {
        'expand for details', 'channel', 'channels', 'channel type', 'rationale',
        'kpis', 'outcome', 'platform', 'investment', 'goals', 'goals (conversion/ application)',
        'start - end date', 'start date/end date', 'type', 'number', 'total',
        'click here', 'details', 'strategic breakdown', 'roles', 'logic',
        'initial process', 'region expansion', 'industry expansion', 'cost',
        'cost to implement', 'cpm', 'est. reach', 'n/a', 'na', '', 'campaign type',
        'suggestions', 'option 1', 'option 2', 'option 3', 'awareness',
        'application generation', 'employer branding', 'applications',
        'hiring campaigns', 'awareness campaigns', 'non-traditional channels',
        'traditional channels', 'channel strategy', 'channel details',
        'category 1 - hard to fill', 'category 2 - easy to fill',
    }
    ...
    for row, col, val in cells:
        ...
        if col in (3, 4):  # columns C, D
            ...
            if any(kw in sl for kw in ['expand for', 'click here', 'rationale', 'kpis',
                                        'salary', 'market', 'cost of living', 'labor market',
                                        'key competitive', 'competitor', 'threat', 'hiring focus',
                                        'the salary', 'average', 'unemployment', 'workforce',
                                        'direct role', 'high-volume', 'niche skill', 'public sector',
                                        'emerging', 'systematic', 'future capability',
                                        'existential', 'maximum stability', 'primary poaching']):
                continue
...
def extract_rtx_us(wb):
    ...
    plan = {
        ...
        "regions": ["Christchurch, New Zealand", "Melbourne, Australia", "Sydney, Australia",
                     "Brisbane, Australia", "Newcastle, Australia"],
        "roles": [
        ...
        "channel_strategy": {
            ...
            "employer_branding": {
                ...
                "spotify_programmatic": {"investment": 20000, "cpm": "$15-$25", "reach": 1000000},
                "employer_assessment_sites": {"investment": 30000},
                "alternative_channels": {"investment": 3000}
            },
            "trade_shows": {
                "nz_total": 31000,
                "suggested": ["EMEX 2026", "NZ Aerospace Summit", "Warbirds Over Wanaka"],
                "australia_shows": ["Australian International Airshow", "RotorTech 2026",
                                     "MRO Australasia 2026", "Australian Manufacturing Week 2026", "CeMAT Australia 2026"]
            }
        },
        "benchmarks": {
            "applications_pricing_new": {
                "level_3": {"pay_scale": 60000, "cth_pct": 0.10, "ath": 0.02, "applicants": 2250, "cost": 270000, "cpa": 120},
                "level_2": {"pay_scale": 60000, "cth_pct": 0.08, "ath": 0.015, "applicants": 3000, "cost": 216000, "cpa": 72},
                "level_1": {"pay_scale": 60000, "cth_pct": 0.05, "ath": 0.015, "applicants": 3000, "cost": 135000, "cpa": 45}
            },
        ...
        "channels_used": {
            "global_job_boards": [
                "Indeed", "LinkedIn", "Jora", "JobRapido", "GrabJobs", "JobsSearch", "beBee",
                "WhatJobs", "Adzuna", "Allthetopbananas", "Talent.com", "Michael Page",
                "J-Vers", "Results Generations", "QuickToJobs.com", "Tablerotrabajo",
                "Drjobpro", "Job Matrix", "PowerToFly", "Sercanto", "Jobtome",
                "Energy Jobline", "Recruit.net", "Trovit", "JobsInNetwork", "Jobsora",
                "Talent Inc.", "Jobted", "Jobomas", "Locanto", "College Life Work",
                "Mitula", "Expat.com", "Remoteage", "Digi-Me", "GoOverseas",
                "CareerJet", "The Muse", "eFinancialCareers", "Teachaway", "Remote"
            ],
            "regional_job_boards": [
                "SEEK", "Gumtree", "Trade Me Jobs", "CareerOne", "New Zealand Jobs",
                "NZ Jobs Search", "jobspace.co.nz", "Mustakbil", "job.co.nz", "Remarkable Group"
            ],
            "niche_job_boards": [
                "Techtrade", "WORK180", "Kinexus", "Latest Pilot Jobs",
                "Rishworth Aviation", "Aerocareers NZ", "Trade Jobs NZ"
            ],
            "cpqa_partners": [
                "INS Global", "Lundi", "1840", "Visage Jobs", "High5Hire",
                "Recruiter.com", "Landingjobs"
            ],
            "data_partners": ["JuiceBox", "Seekout"],
            "employer_branding": {
                "programmatic_audio": ["Spotify", "Rova (Media Works)"],
                "dsps": ["StackAdapt", "InMobi", "Microsoft Bing", "Amazon Ads",
                          "Eskimi", "Taboola", "Brandzooka", "Quora Ads", "Uber Ads"],
                "employer_assessment": ["Glassdoor", "Payscale"],
                "influencer_platforms": ["Hypeauditor", "Ubiquitous", "CreatorIQ",
                                          "Upfluence", "Flockity", "Influencity"],
...
def extract_bae(wb):
    ...
    plan = {
        ...
        "regions": ["Norfolk, Virginia", "Virginia Beach, Virginia", "Newport News, Virginia", "Portsmouth, Virginia"],
        "roles": [
            "Electricians", "Pipefitters", "Welders", "Shipfitters", "Riggers", "Outside Machinists",
            "Non-Destructive Testing (NDT) Inspectors", "Quality Assurance (QA) Techs", "Safety Inspectors",
            "Ship Superintendents", "Project Managers", "Schedulers (Primavera P6)", "Estimators"
        ],
        ...
        "channel_strategy": {
            "skilled_trades": {
                "channels": ["Regional Job Boards", "Veteran Job Boards", "Global Job Boards",
                             "Niche Job Boards", "Media Channels", "DSPs",
            ...
            "technical_support": {
                "channels": ["Regional Job Boards", "Veteran Job Boards", "Global Job Boards",
                             "Niche Job Boards", "CPQA Partners", "Data Partners",
                             "Media Channels", "Govt Job Boards"],
            ...
            "managers": {
                "channels": ["Global Job Boards", "Niche Job Boards", "CPQA Partners",
                             "Data Partners", "Media Channels"],
        ...
        "channels_used": {
            "regional_job_boards": [
                "Jobcase Inc", "Snagajob", "Talroo", "Upward.net", "Friday Jobs",
                "OnTimeHire", "JobLookup Ltd", "TopUSAJobs.com", "Propel", "AllJobs",
                "Joboola", "EarnBetter", "Gigs", "Resume-Library.com", "iHire",
                "Directly Apply", "Myjobhelper", "Click2Job", "Bandana", "OfferUp",
                "Zippia", "SonicJobs", "Nexxt", "JobList", "Job.com", "Sonara.ai",
                "WayUp", "Alpha", "JobsRUs.com", "Talentify", "JobSparx", "Tutree",
                "Ellow.io", "FlexBoard", "Workew", "REAL JOBS", "Juvo Jobs",
                "NUL Jobs Network", "Open Work", "Mediabistro", "Skuad",
                "Caliber Sourcing", "Flyrim Tech Corp", "HireEazy", "UltraJobseekers",
                "InstaJob", "Geographic Solutions", "Jobvertise", "Nexustalentpartner",
                "Wonsulting", "Foh and Boh", "Jobing", "Hire a Hero", "theladders.com",
                "IT JOB PRO", "Vue Jobs", "Job Cube", "Skillsire", "Build Dream Career",
                "ConstructionJobForce", "Jobs4all USA", "Jobcube", "Job Seeker",
                "WorkWaveConnect", "CareerBuilder", "Careerhound", "RippleMatch",
                "PostJobFree", "Jobted"
            ],
            "veteran_job_boards": [
                "RecruitMilitary", "VetJobs", "Military.com", "Hire Heroes USA",
                "VeteranJobListings.org", "HotJobs.vet", "FedsHireVets.gov",
                "Helmets to Hardhats", "Fastport", "Veteran Staffing Network",
                "Veterans Connect", "Hire Veterans", "Hiring Our Heroes", "Bridge My Return"
            ],
            "global_job_boards": [
                "Indeed", "LinkedIn", "Talent.com", "Jooble", "Craigslist",
                "ZipRecruiter", "Monster", "JobRapido", "Sercanto", "YadaJobs",
                "Allthetopbananas", "Local Staffing LLC", "Adzuna", "CV Library",
                "Jora", "Women for Hire", "WhatJobs", "JobsInNetwork", "Jobsora",
                "Jobtome", "JobSwipe", "Mindmatch.ai", "ClickaJobs", "J-Vers",
                "The Muse", "Smart Recruiters", "Idealist", "College Recruiter",
                "RICS Recruit", "Jobufo", "Jobomas", "CareerJet", "Consultants 500"
            ],
            "niche_job_boards": [
                "NES Fircroft", "Faststream Recruitment Group",
                "PeopleReady Skilled Trades", "MaritimeJobs.com"
            ],
            "cpqa_partners": [
                "Bluecrew", "Lundi", "INS Global", "Alliance Recruitment", "1840",
                "Visage Jobs", "High5Hire", "FStaff", "Recruiter.com", "Search Solutions",
                "Landingjobs", "Trio", "DevsData", "Teilur Talent", "Top Latin Talent",
                "LatamRecruit", "Prometeo Talent", "Combine Global Recruitment",
                "Lock Search Group", "Athyna", "Qadvance", "Draftboard",
                "Tradesmen International", "Mechanic Hub"
            ],
            "data_partners": ["JuiceBox", "People Data Labs", "Seekout"],
            "media_channels": ["Meta Ads", "Google Ads", "LinkedIn Ads + InMails",
                                "WhatsApp Campaigns", "Reddit", "Discord"],
            "dsps": ["InMobi", "StackAdapt", "Microsoft Bing", "Eskimi", "Taboola",
                      "Brandzooka", "Uber Ads", "Amazon Ads", "Quora Ads"],
            "university_recruitment": [
                "Handshake", "12Twenty", "Centura College - Norfolk Campus",
                "Newport News Shipbuilding Trainee Program", "Tidewater Tech"
            ],
            "govt_job_boards": ["USAJOBS", "Jobs.Virginia.Gov", "City of Portsmouth Career Portal"]
        },
        "budget_allocation": {
...
def extract_amazon_india(wb):
    ...
    plan = {
        ...
        "regions": {
            "remote": ["Karnataka", "West Bengal", "Tamil Nadu", "Telangana",
                       "Maharashtra", "Madhya Pradesh", "Uttar Pradesh", "Gujarat"],
            "tier_1_cities": ["Noida", "Bangalore", "Pune", "Mumbai", "Chennai", "Hyderabad", "Kolkata"],
        ...
        "channel_strategy": {
            "scenario_1": {
                ...
                "job_boards": {"impressions": "900K-1.35M", "traffic": "High", "quality": "Low (2% Qualification)", "cps": "$0.6-$0.85"},
                "local_social_media": {"impressions": "500K-800K", "traffic": "Low", "quality": "Low (3% Qualification)", "cps": "$0.5-$0.7"},
                "online_newspaper": {"impressions": "1M-1.5M", "traffic": "High", "quality": "Low (1% Qualification)", "cps": "$0.8-$1"}
            },
            "scenario_2": {
                "description": "Joveo sources 30% of application requirement (~48,000 applications)",
                "job_boards": {"impressions": "1.2M-1.7M", "traffic": "High", "quality": "Low (2% Qualification)", "cps": "$0.7-$0.9"},
                "local_social_media": {"impressions": "700K-1.1M", "traffic": "Low", "quality": "Low (3% Qualification)", "cps": "$0.55-$0.75"},
                "online_newspaper": {"impressions": "1.2M-1.8M", "traffic": "High", "quality": "Low (1% Qualification)", "cps": "$0.85-$1.1"}
            }
        },
        "benchmarks": {
            "old_pricing": {
                "remote": {"cpa": "$6-10", "volume": 5000, "budget": "$30,000-$50,000"},
                "tier_1_in_person": {"cpa": "$12-16", "volume": 3000, "budget": "$36,000-$48,000"},
                "tier_2_in_person": {"cpa": "$10-15", "volume": 2000, "budget": "$20,000-$30,000"}
            },
            "new_traffic_pricing": {
                "remote": {"cpa": "$0.5-1", "volume": 90000, "budget": "$45,000-$80,000"},
                "tier_1_in_person": {"cpa": "$1-1.2", "volume": 45000, "budget": "$45,000-$52,500"},
                "tier_2_in_person": {"cpa": "$0.8-1.1", "volume": 30000, "budget": "$25,000-$33,000"}
            },
            "new_qualified_pricing": {
                "remote": {"cpa": "$10-12", "volume": 2500, "budget": "$25,000-$30,000"},
                "tier_1_in_person": {"cpa": "$15-20", "volume": 4500, "budget": "$60,000-$70,000"},
                "tier_2_in_person": {"cpa": "$12-15", "volume": 2000, "budget": "$25,000-$33,000"}
            },
            "apply_to_day1_start_ratio": "10%",
            "application_funnel": {
                "traffic_channels": {"landing_page": 165000, "account_created": 51150, "apply_completed": 25575, "hired": 511.5},
                "qualified_channels": {"landing_page": 9000, "account_created": 1800, "apply_completed": 720, "hired": 288}
            }
        },
        "channels_used": {
            "global_job_boards": ["Indeed", "Jooble", "Talent.com", "JobRapido", "Sercanto",
                                   "Allthetopbananas", "Adzuna", "Jora", "Jobtome", "Jobsora",
                                   "WhatJobs", "ClickaJobs", "eFinancialCareers", "JobsInNetwork",
                                   "StellenSMS", "Remote", "Trovit.co.in", "CareerJet", "Locanto",
                                   "beBee", "Recruit.net", "Jobomas", "Jobsforhumanity",
                                   "College Recruiter", "Jobted", "Startup Jobs", "PowerToFly",
                                   "Remoteage", "WorkWaveConnect", "Mitula", "Teachaway", "Expat",
                                   "Jobs Search", "Hubstaff Talent", "Himalayas.app", "Classifiedads",
                                   "ACM Career and Job Center", "GoOverseas", "Learn4Good",
                                   "College Life Work", "Results Generations", "Jobble",
                                   "Talent Inc.", "Match IT", "ResumeDone.co", "Drjobpro", "Olx Jobs"],
            "local_job_boards": [
                "Foundit.in", "Jobsquare.co.in", "Hirect", "Shine", "TimesJobs",
                "Internshala", "Quickr", "Apna", "Careerindia.com", "MeraJob.com", "Olx Jobs",
                "Sulekha Jobs"
            ],
            "niche_job_boards": [
                "WorkIndia", "RozgaarIndia / Rozgar.com", "PlacementIndia",
                "WalkInIndia", "HerSecondInnings", "JobsForHer", "Freshersworld",
                "National Career Service (NCS)", "She-Jobs"
            ],
            "staffing_partners": [
                "Hunar.ai", "Athyna", "TeamLease", "High5Hire", "1840",
                "Randstad India", "Quess Corp", "Lobo Staffing"
            ],
            "local_social_media": [
                "Sharechat", "Moj", "Josh", "Koo", "Roposo",
                "Chingari", "Truecaller Ads", "Trell", "Mitron"
            ],
        ...
        "budget_allocation": {
            "channel_types": {"global_niche_job_boards": 3, "digital_newspapers": 3,
                              "local_social_media": 9, "local_job_boards": 10},
    ...
    plan = {
        ...
        "channels_used": {
            "regional_local_job_boards": [
                "Snagajob", "Jobcase Inc", "Talroo", "OnTimeHire", "Upward.net",
                "Geographic Solutions", "Propel", "AllJobs", "EarnBetter", "Myjobhelper",
                "TransForce", "CDLlife", "OfferUp", "SonicJobs", "Botson.ai",
                "CMP Jobs", "JobHubCentral", "PostJobFree", "Search Party",
                "Diversity Jobs", "Nexxt", "Resume-Library.com",
                "Professional Diversity Network", "Nexustalentpartner", "Foh and Boh",
                "CollabWORK", "Class A Drivers", "Craigslist", "Ladders.com",
                "FATj (Gotoro)", "ConstructionJobForce", "CareerBuilder", "Military.com",
                "People Data Labs", "REAL JOBS", "FlexBoard", "JobList", "Job.com",
                "Pushnami", "Geebo", "Direct Employers Association", "HR Jobs",
                "RecruitMilitary", "AARP", "Clearance Jobs", "ClearedJobs.Net",
                "Talentify", "JobSparx", "Tutree", "iHire", "EmployDiversity",
                "NUL Jobs Network", "Our Ability", "Caliber Sourcing", "Circa Works",
                "Getting Hired", "Disability Solutions", "Work without Limits",
                "Jobvertise", "Ability Links", "LGBT Job board", "Womens Job List",
                "Squad Profile", "Flockity"
            ],
            "niche_job_boards": [
                "OCC", "Computrabajo", "Portal del Empleo", "Bumeran", "Expertini",
                "Airswift", "Mechanics Hub", "gCaptain Jobs", "MaritimeJobs.com",
                "RigZone", "SeaCareer", "MarineLink Jobs", "AllMarinerJobs",
                "Maritime Union Job Board", "DieselTechJobs.com", "Roadtechs",
                "Heavy Equipment Jobs", "Brunel", "NES Fircroft", "Atlas Professionals",
                "Faststream Recruitment Group", "PeopleReady Skilled Trades",
                "Tradesmen International", "CraftHire"
            ],
            "global_job_boards": [
                "Local Staffing LLC", "JobGet", "Monster", "Allthetopbananas",
                "JobRapido", "Talent.com", "ZipRecruiter", "Sercanto", "Jooble",
                "JobSwipe", "ClickaJobs", "MyJobScanner", "Jobtome", "Jora",
                "WhatJobs", "J-Vers", "Adzuna", "Mindmatch.ai", "CV Library",
                "AppJobs", "Jobsora", "StellenSMS", "BoostPoint", "Women for Hire",
                "beBee", "College Recruiter", "Job Today", "Results Generations",
                "WorkWaveConnect", "Jobble", "Jobs4humanity", "ResumeDone",
                "Match IT", "Jobted", "Jobomas", "Locanto", "College Life Work",
                "Mitula", "PowerToFly", "Learn4Good", "EvenBreak", "Expat.com"
            ],
            "location_specific_boards": {
                "alameda": ["CalJOBS", "EastBayWorks", "Craigslist Bay Area East Bay", "WorkForGood"],
                "charleston": ["SCWorks Jobs Portal", "CharlestonJobNetwork", "LowcountryJobs",
                                "Craigslist Charleston", "SouthCarolinaJobBoard.com"],
                "honolulu": ["HawaiiJobsOnDemand", "Craigslist Honolulu",
                              "State of Hawaii Jobs Portal", "WorkForce Hawaii"]
            },
            "cpqa_partners": [
                "Bluecrew", "INS Global", "Alliance Recruitment", "1840",
                "Visage Jobs", "High5Hire", "FStaff", "Recruiter.com", "Search Solutions"
            ],
            "data_partners": ["JuiceBox", "Seekout"],
            "media_channels": ["Meta Ads", "Google Ads", "LinkedIn Ads + InMails",
            ...
            "employer_branding": {
                ...
                "influencer_platforms": ["Hypeauditor", "Ubiquitous", "CreatorIQ", "Upfluence"],
                "employer_assessment": ["Glassdoor", "Payscale"],
                "google_display_network": True
            },
            "educational_partners": {
                "alameda": ["College of Alameda", "Universal Technical Institute (UTI)",
                            "Laney College (Oakland)", "Cal Maritime (CSU)",
                            "Operating Engineers Local 3", "Chabot College"],
                "charleston": ["Trident Technical College", "Greenville Technical College",
                                "DoD SkillBridge (JB Charleston)", "Savannah Technical College",
                                "College of Charleston"],
                "honolulu": ["Honolulu Community College", "Hawaii Community College",
                              "UH System", "OE3 Hawaii Training Center",
                              "UH Manoa College of Engineering", "Hawaii Maritime License Center"]
            },
            "radio_stations": {
                "alameda": ["All News 740 AM", "NPR Bay Area", "KGO Talk Radio 810",
                            "La Preciosa", "KOIT 96.5 FM"],
                "charleston": ["Talk Radio 1250 WTMA", "South Carolina Public Radio",
                                "Talk 93.5 FM", "103.5 WEZL"],
                "honolulu": ["Hawaiian 105 KINE", "Island 98.5", "Hawaii Public Radio",
                              "News Radio 830", "93.9 The Beat"]
            },
            "podcasts": {
                "alameda": ["The Bay", "This Week in Startups", "SF Weekly Podcast"],
                "charleston": ["The Southern Fork", "South Carolina Lede", "Charleston Currents"],
                "honolulu": ["The Conversation", "Aloha Authentic", "Hawaii News Now Podcast"]
            }
        },
        "budget_allocation": {
...
def extract_rtx_poland(wb):
    ...
    plan = {
        ...
        "channel_strategy": {
            "tier_3": {
                "awareness": {
                    "channels": ["DSPs", "Influencer Marketing", "Programmatic Audio",
                                 "Non Programmatic Audio", "Alternative Channels", "Employer Branding Websites"],
                    "investment": 50000
                },
                "application_generation": {
                    "channels": ["Regional Job Boards", "Location-Specific Job Boards",
                                 "Global Job Boards", "Niche Job Boards", "CPQA Partners",
                                 "Data Partners", "Media Channels", "Govt Job Boards", "DSPs"],
                    "investment": 100000
                }
            },
            "tier_2": {
                "awareness": {
                    "channels": ["Programmatic Audio", "Alternative Channels", "Employer Branding Websites"],
                    "investment": 30000
                },
                "application_generation": {
                    "channels": ["Regional Job Boards", "Location-Specific Job Boards",
                                 "Global Job Boards", "Niche Job Boards", "CPQA Partners",
                                 "Data Partners", "Media Channels", "Govt Job Boards"],
                    "investment": 80000
                }
            },
            "tier_1": {
        ...
        "channels_used": {
            "regional_job_boards": [
                "Praca.pl", "Pracuj.pl", "GoWork.pl", "Careers in Poland",
                "infopraca.pl", "aplikuj.pl", "absolvent.pl", "rocketjobs.pl",
                "pracatobie.pl", "profesja.pl", "jobs.pl", "jobdesk.pl"
            ],
            "global_job_boards": [
                "Indeed", "LinkedIn", "Sercanto", "Talent.com", "Jooble", "Adzuna",
                "Allthetopbananas", "Jobtome", "AppJobs", "LifeworQ", "Xing",
                "WhatJobs", "ClickaJobs", "JobsInNetwork", "Teachaway", "Digi-Me",
                "GoOverseas", "GrabJobs", "MyJobScanner", "JobsSearch", "beBee",
                "J-Vers", "easyhiring.pro", "JobRapido", "CareerJet", "Jobsora",
                "ResumeDone", "Jobted", "Jobomas", "Jobs Today", "College Life Work",
                "QuickToJobs.com", "eFinancialCareers", "Europe Language Jobs",
                "JobTeaser", "Study Smarter", "EuroJobsites.com",
                "Multilingual Vacancies", "Kaderabotim"
            ],
            "cpqa_partners": [
                "Trio", "Remodevs", "DevsData", "Athyna", "Lundi", "INS Global",
                "Alliance Recruitment", "1840", "Visage Jobs", "High5Hire",
                "Recruiter.com", "Landingjobs"
            ],
            "niche_job_boards": [
                "JSFirm.com", "rzeszowiak.pl", "aviationcv.com", "lento.pl", "bdi.com.pl"
            ],
            "data_partners": ["JuiceBox"],
            "media_channels": ["LinkedIn Ads + InMails", "WhatsApp Campaigns", "Reddit", "Discord"],
    ...
    plan = {
        ...
        "roles": {
            "program_management_leadership": {
                "titles": ["CIO", "CISO", "PM Director", "IT Infrastructure Lead",
                           "Surveillance WF Manager", "Alaska PO", "Sub-PM"],
                "count": 7,
                "difficulty": "Highest",
                "time_to_fill": "60-120 days (executive), 30-60 days (Sub-PM)"
            },
            "information_technology": {
                "titles": ["Automation SME", "Nav Domain SME", "Cyber Architect",
                           "Network Architect", "TELCO Engineer", "Enterprise Architect"],
                "count": 10,
                "difficulty": "High",
                "time_to_fill": "30-60 days"
            },
            "engineering": {
                "titles": ["Surveillance Systems Engineer", "Config Management Sr. Advisor",
                           "QA Engineering Manager", "Facilities Engineer - Telecom"],
                "count": 4,
                "difficulty": "High",
                "time_to_fill": "30-60 days"
            },
            "quality_assurance_audit": {
                "titles": ["Performance & Stability Test Engineer (x2)",
                           "Process Doc Sr. Advisor", "QA Audit Management"],
                "count": 4,
                "difficulty": "Medium",
                "time_to_fill": "30-45 days"
            },
            "contracts_supply_chain": {
                "titles": ["Contracts Admin SA (x6, multi-site)",
                           "Subcontracts Admin SA", "Asset Management SA"],
                "count": 8,
                "difficulty": "Medium",
                "time_to_fill": "20-40 days"
            },
            "aviation_ops_consulting": {
                "titles": ["Data Management Lead", "Aviation Safety SME",
                           "Aviation Safety Liaison", "ATC/TM Liaison"],
                "count": 4,
                "difficulty": "Highest",
        ...
        "channel_strategy": {
            "hard_to_fill": {
                "applicable_roles": ["Program Management & Leadership", "Information Technology",
                                      "Engineering", "Aviation Ops & Consulting"],
                "channels": {
            ...
            "easy_to_fill": {
                "applicable_roles": ["Quality Assurance and Audit", "Contracts and Supply Chain",
        ...
        "channels_used": {
            "regional_job_boards": [
                "Jobcase Inc", "Snagajob", "Talroo", "Upward.net", "OnTimeHire",
                "JobLookup Ltd", "TopUSAJobs.com", "Propel", "AllJobs", "Joboola",
                "EarnBetter", "Gigs", "Resume-Library.com", "iHire", "Directly Apply",
                "Myjobhelper", "Click2Job", "Dice", "Bandana", "OfferUp", "Zippia",
                "SonicJobs", "Nexxt", "JobList", "Job.com", "Sonara.ai", "WayUp",
                "Alpha", "JobsRUs.com", "Talentify", "JobSparx", "Tutree", "Ellow.io",
                "FlexBoard", "Workew", "REAL JOBS", "Juvo Jobs", "NUL Jobs Network",
                "Open Work", "Mediabistro", "Skuad", "Caliber Sourcing",
                "Flyrim Tech Corp", "HireEazy", "UltraJobseekers", "InstaJob",
                "Jobvertise", "Nexustalentpartner", "Wonsulting", "Foh and Boh",
                "Jobing", "theladders.com", "IT JOB PRO", "Vue Jobs", "Job Cube",
                "Skillsire", "Build Dream Career", "Jobs4all USA", "Jobcube",
                "Job Seeker", "WorkWaveConnect", "CareerBuilder", "Careerhound",
                "RippleMatch", "PostJobFree", "Jobted", "The Talent Oasis",
                "UniversalHelpWanted", "USJobLink", "ASQ", "Washington Post",
                "Fylter", "Minnesota Jobs", "C Squared", "AdministrativeJobs",
                "Business Workforce", "LogisticsJobSite", "TechCareers", "JobFox",
                "Jobit_com", "JSfirm", "JustJobs", "KCJobs", "LasVegasJobs",
                "LPJobs", "Apptness", "NRF", "OKCJobs", "OneWire", "OppsPlace",
                "OptiJob", "NewYorkJobs", "AMA", "Ver Jobs", "Irecruitee",
                "NPSE", "PublicServiceCareers", "Built In", "Instawork",
                "Scale Jobs", "Lifeshack", "College Grad", "After College",
                "AccessDubuque", "Society of Women Engineers (SWE)",
                "CareerJournal", "Cooperative", "CPGJobList", "CyberSecJobs",
                "EngineerJobs", "FINS", "HCareers", "Hippo"
            ],
            "global_job_boards": [
                "Indeed", "LinkedIn", "Talent.com", "Jooble", "Craigslist",
                "ZipRecruiter", "JobRapido", "Sercanto", "YadaJobs",
                "Allthetopbananas", "Local Staffing LLC", "Adzuna", "CV Library",
                "Jora", "Women for Hire", "WhatJobs", "JobsInNetwork", "Jobsora",
                "Jobtome", "JobSwipe", "Mindmatch.ai", "ClickaJobs", "J-Vers",
                "The Muse", "Smart Recruiters", "Idealist", "College Recruiter",
                "RICS Recruit", "Jobufo", "Jobomas", "CareerJet", "Consultants 500",
                "Career Seeker", "Innovia Solutions LLC", "JobGet", "MyJobScanner",
                "JobsSearch", "beBee", "Job Today", "Results Generations",
                "WorkWaveConnect", "Recruit.net", "AppJobs", "Jobble", "StellenSMS",
                "ResumeDone", "Nudge Recruitment Marketing", "Match IT",
                "Talent Inc.", "Jobgoal", "Jobted", "Brilliant Jobs",
                "Reticular Media", "Jobguard", "Nexus Lead Services",
                "Find Every Job", "JobSearch.Coach", "Study Smarter",
                "Remotive", "Disrupted Cloud", "Nomad Jobs", "Gen Z Jobs",
                "Banya Talent", "Uplift Media", "Himalayas", "Sumo-D",
                "Sorce.jobs", "ACM Career and Job Center", "Hackajob",
                "Career Days", "Artha Job boards", "Gamasutra",
                "GlobalWorkplace", "INCOSE", "InfoMine", "ISPE", "JobServe", "NiceJob"
            ],
            "niche_job_boards": [
                "ClearanceJobs", "NES Fircroft", "Faststream Recruitment Group",
                "NTSB Careers", "FAAJobs"
            ],
            "cpqa_partners": [
                "Search Solutions", "Teilur Talent", "Lock Search Group",
                "Qadvance", "Draftboard",
                "Egon Zehnder", "Heidrick & Struggles", "Spencer Stuart",
                "Russell Reynolds Associates", "N2Growth", "DHR Global",
                "ADK Consulting & Executive Search", "The McCormick Group",
                "Benchmark Executive Search", "Diversified Search", "Boyden",
                "Cabot Consultants", "Isaacson, Miller", "The Burgess Group"
            ],
            "data_partners": [
                "JuiceBox", "Parker Dewey", "Crustdata",
                "People Data Labs", "Seekout"
            ],
            "media_channels": ["Meta Ads", "Google Ads", "LinkedIn Ads + InMails",
                                "WhatsApp Campaigns", "Reddit", "Discord"],
            "dsps": ["InMobi", "StackAdapt", "Microsoft Bing", "Eskimi", "Taboola",
                      "Brandzooka", "Uber Ads", "Amazon Ads", "Quora Ads"],
            "university_recruitment": [
                "Handshake", "12Twenty", "Purdue University",
                "University of Florida", "University of Hawaii-Manoa",
                "Walsh College", "UC Davis School of Law",
                "University of Notre Dame - Business", "Georgia Tech University",
                "University of Denver", "Wichita State University",
                "University of Texas Austin (Engineering)", "Schoolcraft College",
                "Rhodes State College", "University of Michigan - Engineering",
                "Columbia University - Engineering",
                "University of Missouri Science & Tech",
                "University of Massachusetts Amherst",
                "University Job Board of Iowa"
            ],
            "govt_job_boards": ["USAJOBS", "Jobs.Virginia.Gov",
                                 "City of Portsmouth Career Portal", "Geographic Solutions"]
        },
        "budget_allocation": {
...
def compute_aggregate_patterns(plans):
    ...
    industry_prefs = {
        "aerospace_defense": {
            "key_channels": ["Programmatic Job Boards", "CPQA Partners", "Trade Shows",
                              "Influencer Marketing", "DSPs", "Aviation-specific niche boards"],
            ...
            "unique_approaches": ["Aviation Valley targeting (Poland)", "Trade show sponsorships (NZ/AU)",
                                   "Influencer marketing for blue-collar roles"]
        },
        "defense_shipbuilding": {
            "key_channels": ["Veteran Job Boards", "Regional Job Boards", "CPQA Partners",
                              "Maritime-specific niche boards", "Govt Job Boards"],
            ...
            "unique_approaches": ["SkillBridge and Warrior Integration Programs",
                                   "Clearance-specific job boards", "Region expansion strategy"]
        },
        "technology_ecommerce": {
            "key_channels": ["Local Job Boards (market-specific)", "Local Social Media",
                              "Newspapers", "Staffing Partners"],
            ...
            "unique_approaches": ["Local social media platforms (Sharechat, Moj)",
                                   "Newspapers as English fluency qualifiers",
                                   "Two-scenario budget modeling"]
        },
        "marine_defense_engineering": {
            "key_channels": ["Meta Ads", "Google PMax", "DSPs", "Marine-specific niche boards",
                              "Radio/Podcasts", "Educational Partners"],
            ...
            "unique_approaches": ["5-year brand awareness roadmap", "Blue-collar influencer marketing",
                                   "Location-specific radio/podcast strategy",
                                   "Employee Ambassador Program (2.0x ROI)"]
        },
        "defense_it_aviation": {
            "key_channels": ["Executive Search Firms", "ClearanceJobs", "University Partnerships",
                              "Data Partners", "FAA-specific boards"],
            ...
            "unique_approaches": ["Executive search for C-suite roles",
    ...
    common_dsps = ["InMobi", "StackAdapt", "Microsoft Bing", "Eskimi",
                    "Taboola", "Brandzooka", "Uber Ads", "Amazon Ads", "Quora Ads"]

    # Common CPQA partners
    common_cpqa = ["INS Global", "Lundi", "1840", "Visage Jobs", "High5Hire",
                    "Recruiter.com", "Alliance Recruitment"]
...
def main():
    ...
    kb = {
        ...
        "industries_covered": list(set(p.get("industry", "unknown") for p in plans.values())),
        "plans": plans,
