"""Legacy Excel media plan generator.

Extracted from app.py to reduce its size. This is the original single-function
Excel generation that creates a comprehensive workbook. The newer excel_v2.py
is the preferred generator; this serves as a fallback.
"""
