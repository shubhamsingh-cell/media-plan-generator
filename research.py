...
REGIONAL_HIRING_DIFFICULTY = {
    "San Francisco, CA": {"difficulty": 8.5, "unemployment": 3.2, "tightness": "very_tight", "top_challenge": "extreme COLI, tech salary inflation"},
    "San Jose, CA": {"difficulty": 8.8, "unemployment": 2.8, "tightness": "very_tight", "top_challenge": "Silicon Valley competition"},
    "New York, NY": {"difficulty": 7.5, "unemployment": 4.0, "tightness": "tight", "top_challenge": "high COLI, competitive talent market"},
    "Boston, MA": {"difficulty": 7.8, "unemployment": 3.0, "tightness": "very_tight", "top_challenge": "biotech/healthcare competition"},
    "Seattle, WA": {"difficulty": 8.0, "unemployment": 3.1, "tightness": "very_tight", "top_challenge": "tech giant competition (Amazon, Microsoft)"},
    "Washington, DC": {"difficulty": 7.2, "unemployment": 3.5, "tightness": "tight", "top_challenge": "clearance requirements, govt competition"},
    "Los Angeles, CA": {"difficulty": 6.8, "unemployment": 4.5, "tightness": "moderate", "top_challenge": "COLI, entertainment industry competition"},
    "Denver, CO": {"difficulty": 7.0, "unemployment": 3.2, "tightness": "tight", "top_challenge": "rapid growth, housing costs"},
    "Austin, TX": {"difficulty": 7.2, "unemployment": 2.9, "tightness": "tight", "top_challenge": "tech expansion, rapid population growth"},
    "Chicago, IL": {"difficulty": 5.8, "unemployment": 4.2, "tightness": "moderate", "top_challenge": "talent retention to coasts"},
    "Dallas, TX": {"difficulty": 5.5, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "corporate relocation competition"},
    "Houston, TX": {"difficulty": 5.2, "unemployment": 4.0, "tightness": "moderate", "top_challenge": "energy sector volatility"},
    "Atlanta, GA": {"difficulty": 5.5, "unemployment": 3.8, "tightness": "moderate", "top_challenge": "rapid growth straining talent pool"},
    "Miami, FL": {"difficulty": 6.0, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "COLI, bilingual talent demand"},
    "Minneapolis, MN": {"difficulty": 6.5, "unemployment": 2.8, "tightness": "tight", "top_challenge": "low unemployment, harsh winters"},
    "Phoenix, AZ": {"difficulty": 5.0, "unemployment": 3.8, "tightness": "moderate", "top_challenge": "semiconductor expansion hiring surge"},
    "Portland, OR": {"difficulty": 6.2, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "tech layoffs creating churn"},
    "Nashville, TN": {"difficulty": 5.8, "unemployment": 3.0, "tightness": "tight", "top_challenge": "healthcare hub competition"},
    "Raleigh, NC": {"difficulty": 6.0, "unemployment": 3.2, "tightness": "tight", "top_challenge": "Research Triangle tech competition"},
    "Salt Lake City, UT": {"difficulty": 5.5, "unemployment": 2.5, "tightness": "tight", "top_challenge": "low unemployment, growing tech scene"},
    "Charlotte, NC": {"difficulty": 5.0, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "banking hub, finance talent competition"},
    "Tampa, FL": {"difficulty": 4.8, "unemployment": 3.8, "tightness": "moderate", "top_challenge": "seasonal workforce fluctuation"},
    "Orlando, FL": {"difficulty": 4.5, "unemployment": 4.0, "tightness": "balanced", "top_challenge": "hospitality/tourism dominance"},
    "San Diego, CA": {"difficulty": 6.5, "unemployment": 3.5, "tightness": "tight", "top_challenge": "military/defense competition, COLI"},
    "Philadelphia, PA": {"difficulty": 5.5, "unemployment": 4.2, "tightness": "moderate", "top_challenge": "pharma hub competition"},
    "Pittsburgh, PA": {"difficulty": 4.5, "unemployment": 4.5, "tightness": "balanced", "top_challenge": "brain drain to larger cities"},
    "Kansas City, MO": {"difficulty": 4.2, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "limited tech talent pool"},
    "Columbus, OH": {"difficulty": 4.5, "unemployment": 3.8, "tightness": "moderate", "top_challenge": "Intel expansion creating demand surge"},
    "Indianapolis, IN": {"difficulty": 4.0, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "logistics hub, blue collar competition"},
    "Detroit, MI": {"difficulty": 4.8, "unemployment": 5.0, "tightness": "balanced", "top_challenge": "EV transition disrupting auto workforce"},
    "Milwaukee, WI": {"difficulty": 4.2, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "manufacturing skill gap"},
    "St. Louis, MO": {"difficulty": 4.0, "unemployment": 3.8, "tightness": "moderate", "top_challenge": "talent retention, healthcare demand"},
    "Las Vegas, NV": {"difficulty": 4.5, "unemployment": 5.0, "tightness": "balanced", "top_challenge": "hospitality dominance, seasonal swings"},
    "San Antonio, TX": {"difficulty": 3.8, "unemployment": 3.8, "tightness": "moderate", "top_challenge": "military base employment"},
    "Jacksonville, FL": {"difficulty": 4.0, "unemployment": 3.5, "tightness": "moderate", "top_challenge": "logistics/finance growth"},
    "Louisville, KY": {"difficulty": 3.8, "unemployment": 3.8, "tightness": "moderate", "top_challenge": "UPS/logistics hub competition"},
    "Memphis, TN": {"difficulty": 3.5, "unemployment": 4.5, "tightness": "balanced", "top_challenge": "FedEx dominance, blue collar competition"},
    "Oklahoma City, OK": {"difficulty": 3.5, "unemployment": 3.2, "tightness": "moderate", "top_challenge": "energy sector shifts"},
    "Richmond, VA": {"difficulty": 4.5, "unemployment": 3.2, "tightness": "moderate", "top_challenge": "government/defense competition"},
    "Birmingham, AL": {"difficulty": 3.2, "unemployment": 3.8, "tightness": "balanced", "top_challenge": "healthcare system competition"},
    "Boise, ID": {"difficulty": 5.5, "unemployment": 2.8, "tightness": "tight", "top_challenge": "rapid growth, limited talent pool"},
    "Des Moines, IA": {"difficulty": 4.0, "unemployment": 2.5, "tightness": "tight", "top_challenge": "insurance hub, low unemployment"},
    "Omaha, NE": {"difficulty": 3.8, "unemployment": 2.8, "tightness": "tight", "top_challenge": "finance/insurance competition"},
    "Tucson, AZ": {"difficulty": 3.5, "unemployment": 4.0, "tightness": "balanced", "top_challenge": "limited industry diversity"},
    "Buffalo, NY": {"difficulty": 3.8, "unemployment": 4.5, "tightness": "balanced", "top_challenge": "population decline, brain drain"},
    "El Paso, TX": {"difficulty": 3.0, "unemployment": 4.5, "tightness": "balanced", "top_challenge": "bilingual talent demand, border economy"},
    "Albuquerque, NM": {"difficulty": 3.2, "unemployment": 4.2, "tightness": "balanced", "top_challenge": "limited tech talent, government dependency"},
    "Bakersfield, CA": {"difficulty": 3.5, "unemployment": 6.0, "tightness": "loose", "top_challenge": "agriculture/oil dependency"},
    "McAllen, TX": {"difficulty": 2.8, "unemployment": 6.5, "tightness": "loose", "top_challenge": "border economy, limited industry"},
    "Fresno, CA": {"difficulty": 3.2, "unemployment": 6.2, "tightness": "loose", "top_challenge": "agriculture dominance, seasonal labor"},
}
