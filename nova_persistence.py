...
# ---------------------------------------------------------------------------
# S76c: Share-link helpers (create_share_link, get_shared_conversation,
# delete_share_link) removed -- the live /api/chat/share endpoint in app.py
# uses its own inline implementation via _supabase_rest. These helpers were
