...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '  box-shadow: 0 8px 30px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.18);'
      ...
      + '#nova-float-btn.nova-btn-close { background: linear-gradient(135deg, #111 0%, #6366F1 100%); border-color: rgba(255,255,255,0.15); }'
      ...
      + '  font-family: "SF Mono", Monaco, Menlo, monospace; font-size: 11.5px; color: #818cf8;'
      + '}'
      + '.nova-msg-assistant p { margin: 4px 0; }'
      + '.nova-msg-assistant a { color: #818cf8; text-decoration: underline; }'
      ...
      + '  background: rgba(255,255,255,0.04); color: #818cf8;'
      ...
      + '.nova-tooltip-title { font-weight: 600; margin-bottom: 4px; font-size: 12px; color: #818cf8; }'
      ...
      + '  font-size: 9px; color: #666666; font-weight: 600;'
      ...
      + '  line-height: 1.5; background: rgba(255,255,255,0.04);'
      + '  color: #ededed;'
      ...
      + '}'
      + '.nova-input::placeholder { color: #666666; }'
      + '.nova-send-btn {'
