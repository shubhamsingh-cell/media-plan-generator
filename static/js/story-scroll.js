...
function initStoryScroll() {
  ...
  progressStyle.textContent = [
    ...
    "  background: linear-gradient(180deg, var(--accent, #5A54BE), var(--teal, #6BB5CE));",
    ...
    "}",
    ".story-arrow:hover {",
    "  border-color: var(--accent, #5A54BE);",
    "  color: #fff;",
    "  background: rgba(90, 84, 189, 0.3);",
    "}",
    ".story-arrow:focus-visible {",
    "  outline: 2px solid var(--accent, #5A54BE);",
    "  outline-offset: 2px;",
    "}",
    ".story-dot-row {",
    ...
    "  height: 100%; width: 0%;",
    "  background: linear-gradient(90deg, var(--accent, #5A54BE), var(--teal, #6BB5CE));",
